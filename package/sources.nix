{ ... }:
{
  ...
  llonebot_version = "8.1.4";
  llonebot_url = "https://github.com/LLOneBot/LLOneBot/releases/download/v8.1.4/LLBot.zip";
  llonebot_hash = "sha256-7rXu/IUKBVkFhrAGfdXZL4GJxyeVJ/xHfwpBDThOagI=";
}
