{ ... }:
{
  ...
  llonebot_version = "8.1.1";
  llonebot_url = "https://github.com/LLOneBot/LLOneBot/releases/download/v8.1.1/LLBot.zip";
  llonebot_hash = "sha256-j1seWnKX9fFZ3Sxbe0fNiUHVY4AMnAD2RKvZfnU75qA=";
}
