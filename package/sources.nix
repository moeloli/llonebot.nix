{ ... }:
{
  ...
  llonebot_version = "8.1.6";
  llonebot_url = "https://github.com/LLOneBot/LLOneBot/releases/download/v8.1.6/LLBot.zip";
  llonebot_hash = "sha256-p4gp6ERhloBKzyrZom/3oMrI6bmzaSim/c6etcpfGuA=";
}
