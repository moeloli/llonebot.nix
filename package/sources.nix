{ ... }:
{
  ...
  llonebot_version = "8.1.5";
  llonebot_url = "https://github.com/LLOneBot/LLOneBot/releases/download/v8.1.5/LLBot.zip";
  llonebot_hash = "sha256-82SE3KB9cuXuYNy6e6qpP70jg3CbXwIS8tCYCzL5Bls=";
}
