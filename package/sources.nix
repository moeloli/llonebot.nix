{ ... }:
{
  ...
  llonebot_version = "7.3.0";
  llonebot_url = "https://github.com/LLOneBot/LLOneBot/releases/download/v7.3.0/LLBot.zip";
  llonebot_hash = "sha256-itPvjBhDXMMpFUuti5huBAiKoZNRrk0Jam/ah9I5Bs0=";
}
