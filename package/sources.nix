{ ... }: {
  ...
  llonebot_version = "5.0.0";
  llonebot_url = "https://github.com/LLOneBot/LLOneBot/releases/download/v5.0.0/LLOneBot.zip";
  llonebot_hash = "sha256-xB2NQM6H3nlCEOLKvd1M6RfPhcKeXmHa9eVKzAzduBw=";
} 