{ ... }:
{
  ...
  llonebot_version = "8.2.1";
  llonebot_url = "https://github.com/LLOneBot/LLOneBot/releases/download/v8.2.1/LLBot.zip";
  llonebot_hash = "sha256-M5wFenETBK6bGwwTDRXjZ8nu75QKxQbhuOMBwiALRqc=";
}
